...
@interface QMNetManager ()

@end

@implementation QMNetManager
...
{
    static QMNetManager *manager = nil;
                                ...
                                progress:(QMDownloadProgress)progress
{
    ...
    NSLog(@"******************** 请求参数 ***************************");
    NSLog(@"请求头: %@\n请求方式: %@\n请求URL: %@\n请求param: %@\n\n",[self sharedAFManager].requestSerializer.HTTPRequestHeaders, (type == QMHttpRequestTypeGet) ? @"POST":@"GET",URLString, parameters);
    NSLog(@"******************************************************");

    QMURLSessionTask *sessionTask = nil;

    if (type == QMHttpRequestTypeGet)
    {
    ...
    else if (type == QMHttpRequestTypePost)
    {
    ...
    else if (type == QMHttpRequestTypePut)
    {
    ...
    else if (type == QMHttpRequestTypeDelete)
    {
    ...
    [manager setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        ...
        switch (status)
        {
            case AFNetworkReachabilityStatusUnknown: // 未知网络
                NSLog(@"未知网络");
                QMNetManagerShare.netWorkStatus = QMNetworkStatusUnknown;
                break;
            case AFNetworkReachabilityStatusNotReachable: // 没有网络(断网)
                NSLog(@"没有网络");
                QMNetManagerShare.netWorkStatus = QMNetworkStatusNotReachable;
                break;
            case AFNetworkReachabilityStatusReachableViaWWAN: // 手机自带网络
                NSLog(@"手机自带网络");
                QMNetManagerShare.netWorkStatus = QMNetworkStatusReachableViaWWAN;
                break;
            case AFNetworkReachabilityStatusReachableViaWiFi: // WIFI
                
                QMNetManagerShare.netWorkStatus = QMNetworkStatusReachableViaWiFi;
                NSLog(@"WIFI--%lu", (unsigned long)QMNetManagerShare.netWorkStatus);
                break;
        }
    }];
